...
class Music(QWidget):
	...
	def initUI(self):
		...
		btn.setStyleSheet("QPushButton{ border:none;color:red;background-color:white } ")
		...
		btn = QPushButton("电台",funcList).setGeometry(0,40,60,40)
		btn = QPushButton("推荐",funcList).setGeometry(0,80,60,40)
		btn = QPushButton("MV",funcList).setGeometry(0,120,60,40)
		btn = QPushButton("设置",funcList).setGeometry(0,160,60,40)
